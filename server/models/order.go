...
func (o *Order) SetZero() (title, ReceiverName, ReceiverPhone, address, remark string) {
	title, ReceiverName, ReceiverPhone = o.Title, o.ReceiverName, o.ReceiverPhone
	address, remark = o.Address, o.Remark
	o.Title, o.ReceiverName, o.ReceiverPhone = "", "", ""
	o.Address, o.Remark = "", ""
	return
}
