<template>
    <div>
        ...
        <div class="main">
            <!-- 搜索选项 -->
            ID：<el-input type="number" style="width: 80px;" v-model.number="userForm.ID"></el-input>
            ...
            <el-date-picker v-model="userForm.birthday" type="daterange" range-separator="To" start-placeholder="Start date"
                end-placeholder="End date" />
            <!-- 按钮组 -->
            <el-button style="margin-left: 10px;" type="primary" circle title="搜索" @click="searchUser"><el-icon>
                    <Search />
                </el-icon></el-button>
            <el-button type="warning" circle title="清空" @click="clearUserForm"><el-icon>
                    <Refresh />
                </el-icon></el-button>
        </div>
                    ...
                    <el-table :data="tableData">
                        ...
                        <el-table-column label="操作" width="150">
                            <template #default="scope">
                                <!-- 下标index从0开始 -->
                                <el-button size="small" title="详情与编辑" @click="handleEdit(scope.$index, scope.row)"><el-icon>
                                        <Edit />
                                    </el-icon></el-button>
                                <el-button size="small" type="danger" title="删除"
                                    @click="handleDelete(scope.$index, scope.row)"><el-icon>
                                        <Delete />
                                    </el-icon></el-button>
                            </template>
                        </el-table-column>
